1. make the how we do section and read the whole website then use the designs from this compoent and based upon the features in our website update the text in the component. also match the colour theme used in our wesbite
...
2. give top pading to hero section of landing page. give top margin to every page present . 
3. in event page, in hero section update the colour code : use colour of blue-white-black. 
4. in the event page use better network images 
5. in every card either in founder connect page and give better box shadow to blog page. and improve the blog detail page. 
6. add one more section in landing page, am not sure what but i have to extend the site length
